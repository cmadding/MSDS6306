...
maxtemp1990 <- window(maxtemp, start=1990, end=2018)
```
...
plot(maxtemp1990.ses, PI = FALSE, ylab="Temperature", xlab="Year", main="Forecast of Temperatures At Moorabbin Airport, Melbourne", fcol="blue", type="o")
...
plot(maxtemp1990.holt, ylab="Celsius Temperature", xlab= "Year", main="Forecast with Holt Fit")
...
#the ase for the SES method (SSE/n)
...
**The Holt method has an ASE of 4.464942 and the ses is 5.393285, just looking at the ASE, Holt has the better fit.**
